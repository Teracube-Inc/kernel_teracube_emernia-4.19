...
#define SET_ACCESS_PERMISSON_WIFI  SET_ACCESS_PERMISSION
#else
#ifdef CONFIG_MTK_EMI_MPU
#include <mach/emi_mpu.h>
#define SET_ACCESS_PERMISSON_WIFI  SET_ACCESS_PERMISSON
#endif
#endif
...
int HifAhbSetMpuProtect(bool enable)
{
	emi_mpu_set_region_protection(
		...
		SET_ACCESS_PERMISSON_WIFI(UNLOCK, FORBIDDEN, FORBIDDEN,
